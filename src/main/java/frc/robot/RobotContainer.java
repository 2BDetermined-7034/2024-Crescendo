...
//    public static final Photonvision photonvision = new Photonvision(Constants.Vision.shooterMonoCam, Constants.Vision.shooterCamToRobotTransfrom);
    ...
    public RobotContainer() {
        ...
        autoChooser.addOption("Choreo Mid Three Piece Wing", AutoFactory.getAutonomousCommand("Mid Three Piece Wing"));
        ...
        autoChooser.addOption("Test", AutoFactory.getAutonomousCommand("New Auto"));
